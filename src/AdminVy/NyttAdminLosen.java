 ...
 * @author filip
 */
public class NyttAdminLosen extends javax.swing.JFrame {

private static InfDB idb;

//Konstruktor som instansierar vyn för att ändra admins lösenord
    public NyttAdminLosen(InfDB idb) {
        initComponents();
        this.idb = idb;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NyttAdminLosen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

 ...
 * @author filip
 */
public class LaggTillAlien extends javax.swing.JFrame {

private static InfDB idb;

//Konstruktor som instansierar vyn för att lägga till ny Alien
    public LaggTillAlien(InfDB idb) {
        initComponents();
        this.idb = idb;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaggTillAlien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
